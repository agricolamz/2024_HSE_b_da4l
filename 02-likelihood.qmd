...
- Не стоит путать [MLE c градиентным спуском](https://stats.stackexchange.com/questions/183871/what-is-the-difference-between-maximum-likelihood-estimation-gradient-descent/183872#183872)
- MLE --- не единственный способ, смотрите, например, есть Maximum Spacing Estimation [@cheng83; @ranneby84; @anatolyev05], см. `msedist()` из пакета `fitdistrplus`.